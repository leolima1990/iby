...
<body>
    <div class="grid-content-dashboard">
        ...
        <div class="dashboard-links">
            <a href="users-list.php">Users' List</a> <br>
            <a href="users-add.php">Add User</a><br>
            <a href="workout-add.php">Add a New Workout</a><br>
            <a href="users-list.php">Workouts' List</a> 
        </div>
    <footer>
